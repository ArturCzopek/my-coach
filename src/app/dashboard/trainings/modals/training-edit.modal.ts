...
export class TrainingEditModal extends BaseModal implements OnInit {
    ...
    public initDataBeforeOpenModal(): void {
        ...
        this.trainingsService
            .getExercisesWithSessionForTraining(this.selectedTraining.trainingId)
            .first()
            .subscribe(
    ...
    public onEditClick(): void {
        this.trainingsService
            .editTraining(
                new Training(this.selectedTraining.trainingId, this.dateService.parseStringToDate(this.trainingDate),
                this.selectedTraining.setId),
                this.exercisesForTraining
            )
            .first()
            .subscribe(
